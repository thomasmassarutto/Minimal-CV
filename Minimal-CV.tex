    ...
    rowspan=\mainboxheight}
{
    ...
    \begin{tabularx}{\textwidth}{>{\raggedleft\arraybackslash\footnotesize}p{3.3cm} X}

        & \titlefont{\faGraduationCap\enspace Educazione} \\
        \hline \mediumspace

        09/2015 - 06/2020
            & \textbf{Liceo dell'educazione} \\
            & Conseguimento del diploma del bon ton. \\
            & \smallspace

        09/2021 - Presente
            & \textbf{Università della gentilezza} \\
            & Ringraziamenti \& complimenti \\
            & \largespace
        ...
        2016 - 2022
            & \textbf{Temperamatite} \\
            & Varie esperienze come temperamatite.\\
            & \smallspace

        2020
            & \textbf{Guardatore di muri} \\
            & Guardato molti muri.\\
            & Alcuni avevano quadri, altri solo vernice. \\
            & \largespace

        & \titlefont{\faFlask\enspace Progetti} \\
        \hline \mediumspace
        
            & \textbf{Frigo a pedali} \\
            & Un frigo che usa i pedali, utile per chi deve dimagrire. \\
            & \smallspace

            & \textbf{Martello di vetro} \\
            & Martello monouso. \\ 
            & \smallspace

            & \textbf{Profumo inodore} \\
            & Utile per quando nessun'altro profumo ti convince. \\ 
            & \smallspace

            & \textbf{Chiodo bifronte} \\
            & Chiodo con due teste. \\
            & \largespace
